...
;(function(exports) {
  ...
  EvtVat.prototype.ren = function(oldKey, newKey) {
  ...
  EvtVat.prototype.swap = function(a, b, deep) {
    if(this.store[a] && this.store[b]) {
      ...
      this.emit('swap', a, b, deep);
      return deep ? [a, b] : [a.value, b.value];
    }
    else {
      return false;
    }
  ...
  EvtVat.prototype.replace = function(key, oldValue, newValue) {
