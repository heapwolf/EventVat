...
;(function(exports) {
  ...
  EventVat.prototype.addListener = function(event, listener, ttl) {
  ...
  EventVat.prototype.removeListener = function(event) {
    this.listeners(event, true);
  };

  EventVat.prototype.removeAllListeners = function() {
  ...
  EventVat.prototype.listeners = function(event, listener, removeAllListeners) {
